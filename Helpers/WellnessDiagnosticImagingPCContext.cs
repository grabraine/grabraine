...
{
    public class WellnessDiagnosticImagingPCContext : DbContext
    {
        ...
        public DbSet<Facilities> Facilities {get; set;}
         ...
         public WellnessDiagnosticImagingPCContext(DbContextOptions<WellnessDiagnosticImagingPCContext> options)
            : base(options)
        {
