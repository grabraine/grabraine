...
{
    public class QueensChiropracticAssociatesContext : DbContext
    {
        ...
        public DbSet<TimeReport> TimeReport {get; set;}
         ...
         public QueensChiropracticAssociatesContext(DbContextOptions<QueensChiropracticAssociatesContext> options)
            : base(options)
        {
