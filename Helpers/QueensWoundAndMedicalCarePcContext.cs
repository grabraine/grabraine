...
{
    public class QueensWoundAndMedicalCarePcContext : DbContext
    {
        ...
        public DbSet<TimeReport> TimeReport {get; set;}
         ...
         public QueensWoundAndMedicalCarePcContext(DbContextOptions<QueensWoundAndMedicalCarePcContext> options)
            : base(options)
        {
